...
{   
  my ($self, $field) = @_;
  #FIXME TODO besser ein hash mit default werden wie in der nagios.cfg?
  # broker_module muss ein array sein, es sind mehrere möglich
  # ohne vererbung von agordamon::definition arbeiten, ist eh alles anders
